...
function AddOrdonance({ idRdv,handleCloseOrdonance }) {
  ...
  const [dureTraitement, setDureTraitement] = useState(0);
  ...
  async function onSubmit() {
    try {
     ...
     if (Object.keys(medicaments[0]).length > 0){
      ...
      const idRdv = rdv._id;
 console.log("dureTraitementin componement", dureTraitement)
     dispatch(addOrdonanceAsync({ idPatient, idRdv, medicaments, jourFormate, dureTraitement}));
                        ...
                        >
                          ...
                          <MDBCol sm="9">
                            <input
                              ...
                              onChange={(e) => setDureTraitement(e.target.value)}
                            />
                          </MDBCol>
                        </MDBRow>
